...
class GuideManager:
    ...
    def _get_learning_state(
        ...
        # Fix: Use (current_index + 1) to show progress for the current item being viewed
        # This ensures the last item shows 100% progress
        progress = int(((current_index + 1) / total_points) * 100)
