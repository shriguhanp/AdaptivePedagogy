...
class ResearchPipeline:
    ...
    async def _phase1_planning(self, topic: str) -> str:
        ...
        self.logger.info(f"📋 decompose_config: {decompose_config}")
    ...
    async def _phase2_researching(self):
        ...
        """
        # Log researching configuration
        researching_config = self.config.get("researching", {})
        max_iterations = researching_config.get("max_iterations", "NOT SET")
        execution_mode = researching_config.get("execution_mode", "series")
        self.logger.info(f"📋 Researching config: max_iterations={max_iterations}, execution_mode={execution_mode}")
